...
class NetBERTEmbedder(MNMEmbedder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.name = 'NetBERTEmbedder'
        self.training_style = 'NetBERT'
        assert self.training_style in {'NetBERT', 'decoding'}, f'{self.training_style} not supported'
        self._root_training_style = 'NetBERT'
    ...
    def prep_batch(
        ...
        if self.training_style == 'NetBERT':
